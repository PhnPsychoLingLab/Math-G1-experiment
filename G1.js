...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'lib/online_mic/psychojs-2024.2.4.js.map', 'path': 'lib/online_mic/psychojs-2024.2.4.js.map'},
    {'name': 'lib/online_mic/psychojs-2024.2.4.js.LEGAL.txt', 'path': 'lib/online_mic/psychojs-2024.2.4.js.LEGAL.txt'},
    {'name': 'lib/online_mic/psychojs-2024.2.4.js', 'path': 'lib/online_mic/psychojs-2024.2.4.js'},
    {'name': 'lib/online_mic/psychojs-2024.2.4.iife.js.map', 'path': 'lib/online_mic/psychojs-2024.2.4.iife.js.map'},
    {'name': 'lib/online_mic/psychojs-2024.2.4.iife.js', 'path': 'lib/online_mic/psychojs-2024.2.4.iife.js'},
    {'name': 'lib/online_mic/psychojs-2024.2.4.css', 'path': 'lib/online_mic/psychojs-2024.2.4.css'},
...
function exp1_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of exp1_taskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function exp2_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of exp2_taskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function exp3_camera_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of exp3_camera_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function exp3_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of exp3_taskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Saving_Results_RoutineRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Saving_Results_RoutineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
